...
#define CLOCK_SOURCE                                                          USE_PLL_MSI                                                                                      // set by target:RHOMBIO_L476DMW1K
#define LPTICKER_DELAY_TICKS                                                  0                                                                                                // set by target:RHOMBIO_L476DMW1K
...
#define MBED_CONF_APP_SOCK_TYPE                                               UDP                                                                                              // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_CELLULAR_APN                                  "spe.inetd.vodafone.nbiot"                                                                       // set by application[*]
...
#define MBED_CONF_QUECTEL_BC95_PROVIDE_DEFAULT                                1                                                                                                // set by application[*]
#define MBED_CONF_QUECTEL_BC95_RX                                             PA_3                                                                                             // set by application[*]
#define MBED_CONF_QUECTEL_BC95_TX                                             PA_2                                                                                             // set by application[*]
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:RHOMBIO_L476DMW1K
